...
saveRDS(OBJ.merge, file = "OBJ.merge.DEV4.RDS")
# OBJ.merge=readRDS("OBJ.merge.DEV2.RDS")

### plot

pdf(paste0("DimPlot.newDEV4.pdf"), width=10, height=5)
DimPlot(OBJ.merge, reduction = "umap", group.by = c("seurat_clusters", "library"))
dev.off()

pdf(paste0("DimPlot.newDEV4.ImmuneLabel.pdf"), width=6, height=5)
...
pdf(paste0("DimPlot.newDEV4.TumorLabel.pdf"), width=6, height=5)
DimPlot(OBJ.merge, reduction = "umap", group.by = c("TumorLabel"))
dev.off()


### dot plot of 92 genes

# expression across 8 clusters
pdf(paste0("DotPlot.92gene.cluster.pdf"), width=8, height=30)
...
pdf(paste0("DotPlot.92gene.tumor_immune.pdf"), width=8, height=30)
...
pdf(paste0("FeaturePlot.newDEV4.Hepatocytes.pdf"), width=10, height=10)
...
pdf(paste0("FeaturePlot.newDEV4.SinusoidalEC.pdf"), width=10, height=10)
...
pdf(paste0("FeaturePlot.newDEV4.VascularEC.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV4.Cholangiocytes.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV4.StellateCells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV4.KupfferCells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV4.Tcells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV4.Bcells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV4.CDgene.NKcell.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
