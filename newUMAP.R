...
saveRDS(OBJ.merge, file = "OBJ.merge.DE.RDS")
# OBJ.merge=readRDS("OBJ.merge.DE.RDS")

### plot

pdf(paste0("DimPlot.newDE.pdf"), width=10, height=5)
DimPlot(OBJ.merge, reduction = "umap", group.by = c("seurat_clusters", "library"))
dev.off()

pdf(paste0("DimPlot.newDE.ImmuneLabel.pdf"), width=6, height=5)
...
pdf(paste0("DimPlot.newDE.TumorLabel.pdf"), width=6, height=5)
...
pdf(paste0("FeaturePlot.newDE.Hepatocytes.pdf"), width=10, height=10)
...
pdf(paste0("FeaturePlot.newDE.SinusoidalEC.pdf"), width=10, height=10)
...
pdf(paste0("FeaturePlot.newDE.VascularEC.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDE.Cholangiocytes.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDE.StellateCells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDE.KupfferCells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDE.Tcells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDE.Bcells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDE.CDgene.NKcell.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
