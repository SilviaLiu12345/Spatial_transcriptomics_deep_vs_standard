...
saveRDS(OBJ.merge, file = "OBJ.merge.DEV3.RDS")
# OBJ.merge=readRDS("OBJ.merge.DEV2.RDS")

### plot

pdf(paste0("DimPlot.newDEV3.pdf"), width=10, height=5)
DimPlot(OBJ.merge, reduction = "umap", group.by = c("seurat_clusters", "library"))
dev.off()

pdf(paste0("DimPlot.newDEV3.ImmuneLabel.pdf"), width=6, height=5)
...
pdf(paste0("DimPlot.newDEV3.TumorLabel.pdf"), width=6, height=5)
DimPlot(OBJ.merge, reduction = "umap", group.by = c("TumorLabel"))
dev.off()


### dot plot of 616 genes

# expression across 8 clusters
pdf(paste0("DotPlot.616gene.cluster.pdf"), width=8, height=30)
...
pdf(paste0("DotPlot.616gene.tumor_immune.pdf"), width=8, height=30)
...
pdf(paste0("FeaturePlot.newDEV3.Hepatocytes.pdf"), width=10, height=10)
...
pdf(paste0("FeaturePlot.newDEV3.SinusoidalEC.pdf"), width=10, height=10)
...
pdf(paste0("FeaturePlot.newDEV3.VascularEC.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV3.Cholangiocytes.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV3.StellateCells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV3.KupfferCells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV3.Tcells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV3.Bcells.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
...
pdf(paste0("FeaturePlot.newDEV3.CDgene.NKcell.pdf"), width=10, height=10)
FeaturePlot(OBJ.merge, features = plotGene)
dev.off()
